              ...
              <div className="carousel-item active">
                <div className="home-banner home-banner-1">
                  <div className="home-banner-text">
                    ...
                    <h2>
                      Experience superior quality with our premium printer
                      collection
                    </h2>
                    <a href="#products" className="btn btn-danger mt-4">
                      Explore Collection
                    </a>
                  </div>
                </div>
              ...
              <div className="carousel-item">
                <div className="home-banner home-banner-2">
                  <div className="home-banner-text">
                    ...
                    <h2>
                      Master your printing with professional guides and
                      tutorials
                    </h2>
                    <a href="/blogs" className="btn btn-danger mt-4">
                      Discover Resources
                    </a>
                  </div>
                </div>
        ...
        <div className="offers">
          <div className="container">
            <div className="row">
                    ...
                    <div className="offer-inner">
                      <div className="offer-image position-relative overflow-hidden">
                        <img
                          ...
                          alt="Professional Printing Solutions"
                          className="img-fluid"
                        />
              ...
              {/* <!-- Offer Box Two --> */}
              <div
                className="col-sm-6 col-lg-4 mb-lg-0 mb-4 d-flex flex-column justify-content-between"
                style={{ gap: 0 }}
              >
                <Link
                  to="/product/3"
                ...
                >
                  <div
                    className="offer-box text-center position-relative"
                  ...
                  <div className="product-list">
                    <div className="product-image position-relative">
                      <img
                        decoding="async"
                        src="/images/p6.jpg"
                        alt="Compact printer for high-quality prints"
                        className="img-fluid product-image-first"
                      />
                      <img
                        decoding="async"
                        src="/images/p2.jpg"
                        alt="Compact printer alternative view"
                        className="img-fluid product-image-secondary"
                      />
                    </div>
                    <div className="product-name pt-3">
                  ...
                  <div className="product-list">
                    <div className="product-image position-relative">
                      ...
                      <img
                        decoding="async"
                        src="/images/p5.jpg"
                        alt="Color Laser Printer"
                        className="img-fluid product-image-first"
                      />
                      <img
                        decoding="async"
                        src="/images/p6.jpg"
                        alt="Color Laser Printer Alt View"
                        className="img-fluid product-image-secondary"
                      />
                    </div>
                    <div className="product-name pt-3">
            ...
            <div className="overflow-hidden my-5">
              <div className="row">
                <div className="col-sm-12 up_to_off">
                  <img
                    decoding="async"
                    src="https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?w=1400&h=400&fit=crop"
            ...
            <div className="row">
              ...
              <div className="col-lg-5">
                <div className="special-img position-relative">
                  ...
                  <img
                    decoding="async"
                    src="https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?w=800&h=800&fit=crop"
                      ...
                      <div className="testimonial-wrapper">
                        <div className="row">
                          ...
                          <div className="username">
                            ...
                            <p>
                              "Printzaa transformed our office printing
                              workflow. Their premium equipment and exceptional
                              support have exceeded all expectations. The
                              quality and reliability are unmatched!"
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="testimonial-wrapper">
                        <div className="row">
                          ...
                          <div className="username">
                            ...
                            <p>
                              "Outstanding service and top-tier equipment!
                              Printzaa's professional approach and cutting-edge
                              technology have revolutionized our printing
                              capabilities. Highly recommend!"
                            </p>
                          </div>
                        </div>
                      </div>
