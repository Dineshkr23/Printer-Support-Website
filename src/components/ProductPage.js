    ...
    <>
      ...
      <section className="product-page container py-5">
        ...
        <div className="product-description mt-5 p-4 bg-light rounded shadow-sm">
          ...
          <p>
            This all-in-one wireless printer is designed for home and office use. It offers high-speed printing with laser technology,
            delivering sharp and vibrant results. Print from multiple devices seamlessly using wireless connectivity.
            Its compact design fits in any workspace, ensuring quality prints every time.
          </p>
        </div>
        ...
        <div className="product-reviews mt-5 p-4 bg-white rounded shadow-sm">
          ...
          <div className="review-item mb-4 border-bottom pb-3">
            <p><strong>John Doe</strong> - <span className="text-warning">★★★★★</span></p>
            <p>"Setup was seamless and print quality is top-notch. Highly recommend for home offices!"</p>
          </div>
          <div className="review-item border-bottom pb-3">
            <p><strong>Jane Smith</strong> - <span className="text-warning">★★★★☆</span></p>
            <p>"Great value for the price, but the toner runs out faster than expected."</p>
          </div>
        </div>
